...
import pl.otekplay.sectors.packets.impl.user.UserFlyUpdatePacket;
...
public class FlyCommand extends Command {
    ...
    public FlyCommand(String name, GroupType type, String... aliases) {
        super(name, "", aliases);
    ...
    public void execute(CommandSender commandSender, String[] args) {
        ...
        SectorManager.sendPacket(new UserFlyUpdatePacket(pp.getUniqueId().toString()));
    }
}
